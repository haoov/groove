...
import { useSession, type LayoutNode } from '../store';
import { containsLeaf } from '../lib/layout';
import { WorkspacePane } from './WorkspacePane';
import { useAnnotations, type AnnCtx } from './useAnnotations';
...
interface LayoutViewProps {
  node: LayoutNode;
  panes: import('../store').WorkspacePane[];
  activePaneId: string;

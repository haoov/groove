...
import { worktreeFor, mrForWorktree, openFileAnnotations, fileThreads } from '../lib/workspace';
import { ensureTerminalTab } from '../lib/panes';
import { useDiffExpand } from '../hooks/useDiffExpand';
...
import { ChangesView } from './DiffView';
import { CommitDiffView } from './CommitDiffView';
import { MrOverview } from './MrOverview';
import { OverviewView } from './OverviewView';
import { PtyTabBody } from './PtyTabBody';
import { ContextMenu } from './ContextMenu';
import { CodeEditor } from './CodeEditor';
import { killPtyTab } from '../lib/panes';
...
export function WorkspacePane({
  ...
  pane: import('../store').WorkspacePane;
  ann: AnnCtx;
  isActive: boolean;
  multiRepo: boolean;
}) {
